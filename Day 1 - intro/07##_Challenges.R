...
# 6 Show summary of the full dataset
# 7 Create frequency table for cyl
# 8 Create barplot for the table for cyl

# 9 install readxl pachage 
# 10 load the library  
# 11 use browseVignettes(package = "readxl") 
